...
public class Barrel {
    ...
    public void draw() {
        ...
        PennDraw.picture(x, y, "src/assets/barrel.png", 24, 24, angle * neg);
        angle += 5;
    }
    ...
    public static void draw4(Floor[] floors) {
        ...
        PennDraw.picture(0.05, yHeight, "src/assets/barrel.png", 24, 24);
        PennDraw.picture(0.05, yHeight + 2 * radius, "src/assets/barrel.png", 24, 24);
        PennDraw.picture(0.10, yHeight, "src/assets/barrel.png", 24, 24);
        PennDraw.picture(0.10, yHeight + 2 * radius, "src/assets/barrel.png", 24, 24);
    }
